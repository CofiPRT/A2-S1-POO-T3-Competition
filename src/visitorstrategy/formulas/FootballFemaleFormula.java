...
public class FootballFemaleFormula implements ScoreFormula {

	public FootballFemaleFormula() {}
	
	/**
	 * Calculates the score of this football team according to the task
	 * ({@code FEMALE} team : The score of the best player * 2 + the score of
	 * the other players)
	...
	public Double applyOn(ArrayList<Player> players) {
		...
		Player extremePlayer = players.get(0);
